...
class DepResolver:
    ...
    def resolve_external_dep(self, dep: str) -> str | None:
        ...
        if pkg in THIRD_PARTY_MAP:
            ...
            # THIRD_PARTY_MAP entries are explicitly curated MODULE.bazel deps;
            # trust them without checking prebuilt_deps (which tracks getdeps,
            # not MODULE.bazel bazel_dep() declarations).
            return label

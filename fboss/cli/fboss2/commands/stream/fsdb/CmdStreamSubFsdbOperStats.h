...
struct CmdStreamSubFsdbOperStatsTraits : public WriteCommandTraits {
...
class CmdStreamSubFsdbOperStats : public CmdStreamHandler<
                                      CmdStreamSubFsdbOperStats,
                                      CmdStreamSubFsdbOperStatsTraits> {
 public:
  using ObjectArgType = CmdStreamSubFsdbOperStatsTraits::ObjectArgType;
  using RetType = CmdStreamSubFsdbOperStatsTraits::RetType;
  using StreamRetType = CmdStreamSubFsdbOperStatsTraits::StreamRetType;

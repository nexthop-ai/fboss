...
CmdConfigProtocolBgpPeerGroupConfedPeerTraits::RetType
CmdConfigProtocolBgpPeerGroupConfedPeer::queryClient(
  ...
  session.setPeerGroupConfedPeer(peerGroupName, enable);
  session.saveConfig();

  return fmt::format(
      "Successfully {} confederation-peer for peer-group '{}'\n"
      "Config saved to: {}",
...
void CmdConfigProtocolBgpPeerGroupConfedPeer::printOutput(

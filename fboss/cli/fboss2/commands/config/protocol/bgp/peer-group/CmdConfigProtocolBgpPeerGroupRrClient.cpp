...
CmdConfigProtocolBgpPeerGroupRrClientTraits::RetType
CmdConfigProtocolBgpPeerGroupRrClient::queryClient(
  ...
  session.setPeerGroupRrClient(peerGroupName, enable);
  session.saveConfig();

  return fmt::format(
      "Successfully {} route-reflector-client for peer-group '{}'\n"
      "Config saved to: {}",
...
void CmdConfigProtocolBgpPeerGroupRrClient::printOutput(const RetType& output) {

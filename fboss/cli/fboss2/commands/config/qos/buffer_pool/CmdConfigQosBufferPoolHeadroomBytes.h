...
struct CmdConfigQosBufferPoolHeadroomBytesTraits : public WriteCommandTraits {
...
class CmdConfigQosBufferPoolHeadroomBytes
    : public CmdHandler<
          CmdConfigQosBufferPoolHeadroomBytes,
          CmdConfigQosBufferPoolHeadroomBytesTraits> {
 public:
  using ObjectArgType =
      CmdConfigQosBufferPoolHeadroomBytesTraits::ObjectArgType;
  using RetType = CmdConfigQosBufferPoolHeadroomBytesTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const BufferPoolName& bufferPoolName,
      const ObjectArgType& headroomBytesValue);
